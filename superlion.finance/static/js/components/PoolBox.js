    ...
    render() {
        ...
        */
        ...
        if (type === 'token') {
            ...
            if (value.masterchef == 1) {
                console.log('poolWeight,rewardTokenPrice,poolLiquidityUsd');
        ...
        let getOnPancakeLink = 'https://exchange.pancakeswap.finance/#/add/0xe9e7cea3dedca5984780bafc599bd69add087d56/' + value.token1Contract;
